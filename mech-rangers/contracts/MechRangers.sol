...
// Mech Rangers ERC-721 — Production Contract
...
contract MechRangers is ERC721, Ownable, IERC2981, Pausable {
    ...
    function ownerMint(address to, uint256 quantity) external onlyOwner {
        require(quantity <= teamReserve,                        "Exceeds team reserve");
        require(totalSupply + quantity <= MAX_SUPPLY,           "Max supply reached");
    ...
    function setWhitelistOnly(bool wl)        external onlyOwner { whitelistOnly = wl; }
